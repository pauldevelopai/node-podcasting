 ...
 * lib/handlers.js
 *
 * Application logic for Explain Podcast Studio.
 *
...
const DEFAULT_PREVIEW_TEXT =
  "This is a quick test of how this voice sounds in the Explain Podcast Studio.";
...
export async function listVoices(host) {
  return readJsonArray(voicesFile(host)).map(withVoiceDefaults);
}
